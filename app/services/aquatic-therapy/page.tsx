...
export default function AquaticTherapyPage() {
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      {/* ───── STATS BAR ───── */}
      <section className="border-b border-white/10 bg-neutral-900/80">
        <div className="mx-auto grid w-full max-w-5xl grid-cols-2 gap-4 px-4 py-8 sm:px-6 lg:grid-cols-4">
          {STATS.map(({ value, label }) => (
            <div key={label} className="text-center">
              <p className="text-2xl font-bold text-cyan-400 sm:text-3xl">{value}</p>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 hidden aspect-[4/3] w-48 overflow-hidden rounded-xl border-2 border-neutral-800 shadow-2xl md:block">
                <Image
                ...
                {[
                  ...
                  return (
                    <div key={item.text} className="flex items-start gap-3">
                      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-cyan-500/10 border border-cyan-500/30">
      ...
      <section className="bg-neutral-900 py-16 md:py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-8 shadow-lg backdrop-blur-sm sm:p-10 md:p-12">
            <div className="text-center">
              ...
              >
                ...
                <Link
                  ...
                  className={`mt-6 flex w-full items-center justify-center rounded-xl py-3 text-sm font-semibold transition-all ${
                    tier.featured
                      ? "bg-cyan-500 text-neutral-950 hover:bg-cyan-400 shadow-md"
